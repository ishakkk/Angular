...
function createRootTView(rootSelectorOrNode, componentDef, componentBindings, directives) {
  const tAttributes = rootSelectorOrNode ? ['ng-version', '22.0.3'] : extractAttrsAndClassesFromSelector(componentDef.selectors[0]);
...
function getBaseDocUrl() {
  ...
  const isPreRelease = full.includes('-next') || full.includes('-rc') || full === '22.0.3';
